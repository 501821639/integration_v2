    ...
    <div class="page-body">
        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="show-company-nature-add" style="display: none;">
                    <div class="panel">
                        <div class="panel-content">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <input type="text" class="form-control company-nature-name" placeholder="单位性质名长度限制40汉字、字符">
                                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="show-company-nature-update" style="display: none">
                    <div class="panel">
                        <div class="panel-content">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <input type="text" class="form-control company-nature-name" placeholder="单位类型名长度限制40汉字、字符">
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="panel">
                        <div class="panel-content">
                            ...
                            <%--添加单性质型权限--%>
                            <shiro:hasPermission name="companynature:save">
                                <input type="button" class="btn btn-primary animated fadeInRight" id="company-nature-add"
                                       value="添加单位性质">
                            </shiro:hasPermission>

                            <%--删除单位性质权限--%>
                            <shiro:hasPermission name="companynature:delete">
                                <input type="hidden" id="company-nature-delete">
                            </shiro:hasPermission>

                            <%--修改单位性质权限--%>
                            <shiro:hasPermission name="companynature:update">
                                <input type="hidden" id="company-nature-update">
                            </shiro:hasPermission>
...
<script type="text/javascript" src="js/company-nature.js"></script>
