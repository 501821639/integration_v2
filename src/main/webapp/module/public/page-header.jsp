...
<div class="page-header">
    <div class="leftside-header">
        <div class="logo">
            <a href="../../adminAsx/index-fb.html" class="on-click">
                <img alt="logo" src="../../adminAsx/images/header-logo.png" />
            </a>
        </div>
    ...
    <div class="rightside-header">
                    ...
                    <div class="drop-content">
                        <div class="widget-list list-left-element">
                            <ul>
                                <li>
                                    <a href="#">
                                        <div class="left-element"><img alt="John Doe" src="../../adminAsx/images/avatar_1.jpg" /></div>
                                        <div class="text">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="left-element"><img alt="Alice Smith" src="../../adminAsx/images/avatar_2.jpg" /></div>
                                        <div class="text">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="left-element"><img alt="Klaus Wolf" src="../../adminAsx/images/avatar_3.jpg" /></div>
                                        <div class="text">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="left-element"><img alt="Sun Li" src="../../adminAsx/images/avatar_4.jpg" /></div>
                                        <div class="text">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="left-element"><img alt="Sonia Valera" src="../../adminAsx/images/avatar_5.jpg" /></div>
                                        <div class="text">
        ...
        <div class="header-section" id="user-headerbox">
            <div class="user-header-wrap">
                <div class="user-photo">
                    <img src="../../adminAsx/images/default-avatar.jpg" alt="Jane Doe" />
                </div>
                <div class="user-info">
            ...
            <div class="user-options dropdown-box">
                <div class="drop-content basic">
                    <ul>
                        <li> <a href="../../adminAsx/pages_user-profile.html"><i class="fa fa-user" aria-hidden="true"></i> Profile</a></li>
                        <li> <a href="../../adminAsx/pages_lock-screen.html"><i class="fa fa-lock" aria-hidden="true"></i> Lock Screen</a></li>
        ...
        <div class="header-section">
            <a href="/logout"><i class="fa fa-sign-out log-out" aria-hidden="true"></i></a>
        </div>
    </div>
</div>